...
;{ TODO[
; Improve FPS. Îñîáåííî ó ÷àñòèö.
; Ïîâûñèòü ðàçðåøåíèå äî 1024x768.
; Äîäåëàòü ýêñòðàâåðñàëüíóþ àíèìàöèþ Desire.
; Äîäåëàòü àíèìàöèþ ñìîðàæèâàíèÿ FrostBite'îâ.
; Óëó÷øèòü âèçóàëèçàöèþ ïðèöåëà.
; Ïðîâåðèòü âûëåò ïðè ïåðåðîæäåíèè.
; Óëó÷øèòü âèçóàëèçàöèþ Àñêåíäàíòîâ.
; Äîáàâèòü âîçìîæíîñòü îòìåíû äåéñòâèé.
; Óëó÷øèòü ïîääåðæêó Îáåëèñêîâ Áåçðàçëè÷èÿ.
; Äîáàâèòü ïîääåðæêó òåãîâ ðàçìåòêè â áðèôèíãè.
; Ïîäóìàòü î ñîõðàíåíèèè ïàðàìåòðîâ ãåíåðàöèè êàðò.
; Äîáàâèòü óíèêàëüíûå ýôôåêòû ïðè àòàêå ïåðñîíàëüíûõ âðàãîâ.
; Ïîïðàâèòü çàâèñàíèÿ ïðè ðàáîòå ñ XP/Win7 (ïîìîãàåò ñîâìåñòèìîñòü ñ 9X).
; Ñäåëàòü âèçóàëüíîå îòîáðàæåíèå ÷èñëà îòêðûòûõ êàíàëîâ.
; Ïîäóìàòü î óñëîâèÿõ, ïðè êîòîðûõ AI äîæåí ïåðåðîæäàòü Enigma.
; Óìåíüøèòü àíèìàöèîííûé ëàã äî ñìåíû íàñòðîåíèÿ ïîñëå ïåðåíîñà.
; Èñïðàâèòü ïîðÿäîê, â êîòîðîì ïðîèñõîäèò âèçóàëèçàöèÿ îòëîæåííîãî óäàðà ïî ïåðåíîñèìîé öåëè.
; ...Äîáàâèòü åùå Àñêåíäàíòîâ.
; ...Íà÷àòü äåëàòü êàðòû äëÿ êàìïàíèè.
; ...Äîáàâèòü Panoptikum è çàñòàâêó äëÿ íåãî.
; ...Ïîäóìàòü î ãðàôè÷åñêîì ýôôåêòå äëÿ îòêðûòèÿ êàíàëà.
; ...Äîáàâèòü ìèíèìàëüíóþ ñèíõðîíèçàöèþ ñ ìóçûêîé.
; ...Ïîäóìàòü î ïîääåðæêå gamepad'à.
; ...Ïîäóìàòü î ñåòåâîì ðåæèìå.
; ...Ñäåëàòü AutoUpdater.
; ...Äîáàâèòü ìóçûêè.
; ...Improve AI.
;} ]TODO
...
; SDK Bugs[
; CopyPixel(Fast) - íå êîïèðóþò çíà÷åíèå àëüôû.
; 1.01 îòïðàâëÿåò íà ðåíäåð ëèøíèå ïîëèãîíû.
; 1.05 íå ñîðòèðóåò ïðîçðà÷íûå ïîâåðõíîñòè.
; ]SDK Bugs
...
#PVanilla     ; Ñòàíäàðòíûå ïëàòôîðìû ñ ïåðâûõ build'îâ.
#PElevator    ; Ìåíÿùèå âûñîòó áëîêó.
#PIgnorance   ; Reincarnates not welcome !
#PObservatory ; Îòñþäà íà÷èíàåòñÿ Âîçíåñåíèå.
EndEnumeration
;}
;{ --Constants--
#ScreenWidth = 800
...
WaitForFinish.i ; Ïàóçà ïåðåä îáüÿâëåíèåì ðåçóëüòàòîâ èãðû.
CurrentTurn.i
...
ComplexEntityPrefix() : EntityAlpha_(*Child, Alpha) : EndIf ; Ñòàâèì Àëüôó.
If CountChildren_(*Child) : ComplexEntityAlpha(*Child, Alpha)
ComplexEntityPostfix()
EndProcedure

Procedure ComplexEntityColor(*Entity, R, G, B)
ComplexEntityPrefix() : EntityColor_(*Child, R, G, B) : EndIf ; Ñòàâèì öâåò.
...
If Offset : Y = -H + Offset : Else : Y = -H / 2 : EndIf ; Êîððåêòèðîâêà.
EntityBox_(*Entity, -W / 2, Y, -D / 2, W, H, D)         ; Ñòàâèì ðàçìåð áîêñà.
EndProcedure
...
Select Mode ; Âûáèðàåì ïî ðåæèìó.
Case 'Ghost' : ComplexEntityAlpha(*Entity, 0.5) ; Ïðèçðà÷íîå ïðåäñòàâëåíèå.
...
; -Draw border-
If System\Level\ServiceTime : Player2Color(System\Level\CurrentPlayer, -1) ; Ñåðàÿ ðàìêà.
...
Procedure CheckMiniMap() ; Äîäåëàòü.
If System\Options\DisplayMiniMap
...
With *Being
If *Being ; Åñëè Ñóùíîñòü âîîáùå åñòü.
...
If NotifyNeeded() ; Åñëè òðåáóåòñÿ âûâåñòè ïåðäóïðåäèòåëüíûé êóðñîð...
DrawImage_(System\NotifyCursor, System\GUI\MousePos\X, System\GUI\MousePos\Y)
Else : DrawMainCursor() ; Ñòàíäàðòíûé êóðñîð.
EndIf
EndMacro
...
LineUp(*Plr\AlliedTeam)\Y = ToX ; Çàïîìèíàåìè
ToX + #CountersOffset          ; Ñäâèãàåì.
...
Line_(#LSOffset, Y + 1, OldToX - #LineFactor, Y + 1)
EndIf
LineUp(*Plr\AlliedTeam)\X = I ; Â ëþáîì ñëó÷àå îòìå÷àåì ïîñëåäíåå.
EndIf 
; -Draw counter-
...
EndBlitz3d_() : TerminateProcess_(GetCurrentProcess_(), 0) ; Òåïåðü âûõîäèì. Íó, â òåîðèè...
EndMacro
...
SaveOptions()
ShutMusic()
If ToMenu ; Ñïàñèáî Ôðåäó çà íàøå ñ÷àñòëèâîå äåòñòâî.
! JMP MainMenuLbl
Else : Quit() : EndIf 
EndIf
HidePointer_()
...
Define Leave, Result, CursorFlashEdge, *Buffer ; Ïîäãîòîâêà çàäíåãî ôîíà.
System\MaxFPS = #PrettyFPS ; Îãðàíè÷åíèå êàäðîâ äëÿ ðàñïå÷àòêè áðèôèíãà.
If Quick : CursorFlashEdge = 50 ; Óñòàíîâèòü ïåðèîä ìåðöàíèÿ êóðñîðà.
Else : CursorFlashEdge = 2
EndIf
ClearStructure(PPData, PrettyPrintData)
PPData\BackGround = CreateImage_(10, 10, 1)
PauseTrack() ; Îñòàíîâèòü ìóçûêó.
...
UnlockVideoMutex()
SetFont_(System\PPFont) ; Óñòàíîâèòü øðèôò.
...
Wend
;;;;;;;;;;;;;;;;;;;;;;;;;
; Óñòàíîâèòü ðàçìåð áóôôåðà...
PPData\PPBuffer = CreateImage_(#ScreenWidth, #PPTopBorder + Pause * PPData\PrintPos\Bottom, 1)
Pause = 0 : FlashCounter = 0 ; Ñáðîñèòü ñ÷åò÷èêè ïàóçû è ìåðöàíèÿ êóðñîðà.
If Quick : PauseCount = 1 : Else : PauseCount = 5 : EndIf ; Óñòàíîâèòü çíà÷åíèå ïàóçû.
Color_(0, 215, 0) ; Óñòàíîâèòü öâåò ïå÷àòè áóêâ.
PPData\Timer = CreateTimer_(#PrettyFPS) ; Ñîçäàòü ñèíõðîíèçèðóþùèé òàéìåð.
...
ResumeTrack()  ; Âîññòàíîâèòü ïðîèãðûâàíèå ìóçûêè.
ProcedureReturn Result
EndProcedure

Procedure.S FormatStory(Story.S, ForQuick = #False)
If ForQuick <> 'Alt' ; Åñëè íå òðóáåòñÿ àëüòåðíàòèâíûé âûâîä.
...
ClsColor_(0, 0, 0) : Cls_() ; Ñðàçó î÷èùàåì ýêðàí è ïîêàçûâàåì:
...
System\GUI\Noised - 1 ; Ñíèæàåì ñ÷åòèê, êîëè óæ.
EndMacro

Macro BadMonitor() ; Partializer
If System\Level\WaitforFinish Or System\Options\InstableOut = 0 : System\GUI\Noised = 0 ; Íàîáîðîò óáèðàåì øóì.
ElseIf Random(150) = 0 : System\GUI\Noised + 2 + Random(5) : EndIf ; Èíîãäà - çàøóìëÿåì.
EndMacro
;}
;{ --Data basing--
...
ElseIf \Infection >= #EpidemiaStart / 2 ; Òóò ñëó÷àé ñëîæíåå...
...
Else : *Team\PlayersCount - 1 ; Ñíèæàåì ñ÷åò÷èê.
ForEach System\Beings() : *Being = System\Beings()
If System\Players(*Being\Owner)\AlliedTeam = \AlliedTeam
AddBeing2UpdateList(*Being, #False) : EndIf ; Ñòàâèì íà îáíîâëåíèå.
Next ; Ïðîäîëæàåì ñî ñ÷åò÷èêîì.
...
Procedure MarkMinimap(*Being.Being) ; Äîäåëàòü !
Define X, Y
With *Being
...
Else : ProcedureReturn "All" ; Âñå-âñå.
EndIf
EndProcedure
...
Procedure ScriptCounter(PlayerIdx) ; Äîäåëàòü !
...
With *Being
; Ïîäãîòîâêà ê îòîáðàæåíèþ òàáëèöû.
...
WhiteText("Owner: ") 
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If *Being\Owner ; Åñëè ýòî íå íåéòðàë...
TeamIdx = Player2TeamIdx(\Owner) ; Èíäåêñ.
*Team = System\Teams(TeamIdx)    ; Óêàçàòåëü.
...
EndIf ; Èíà÷å ðàïîðòóåì íåéòðàëèòåò:
...
ColorText(TypeName)
If Unfreezable(*Being) ; Åñëè Ñóùíîñòü ìîæåò áûòü çàìîðîæåíà...
ColorText("Can't be frozen.") 
ElseIf \Frozen ; Åñëè Ñóùíîñòü çàìîðîæåíà...
...
EndIf
If \Type = #BSociety Or \Type = #BDefiler ; Åñëè Ñóùíîñòü ìîæåò îòêðûâàòü êàíàëû...
...
EndIf
ColorText(TypeName)
If \Ascended = #False ; Åñëè ñóùíîñòü íå âîçíåñåíà...
If CanBeInfected(*Being) ; Åñëè Ñóùíîñòü ìîæåò áûòü çàðàæåíà...
If MindInfected(*Being) ; Åñëè íåðâíàÿ ñåêöèÿ Ñóùíîñòè ïîäàâëåíà...
ColorText("Critically infected !")    ; Âûâîäèì ïðåäóïðåæäåíèå.
Else : WhiteText("Infection level: ") ; Âûïèñûâàåì óðîâåíü çàðàæåíèÿ.
If \Infection > 1 : ColorText(Roman(\Infection), #True)  ; Ñòàíäàðòíûé öâåò.
Else : ColorText(Roman(\Infection)) : EndIf ; Ôèîëåòîâûé öâåò (äàáû áûëî ÿñíåå).
EndIf
...
If Not ColdFusion(*Being) ; Åñëè íå èäåò õîëîäíûé ñèíòåç.
If DelayTargeting(*Being) ; Åñëè ãîòîâèòñÿ îòëîæåííûé óäàð...
...
If \Ascended And Sacrificer(*Being) = #False ; Îòäåëüíî - âîçíåñåííûì.
...
EndIf
ColorText(TypeName)
If \Ascended ; Åñëè ýòî àñêåíäàíò...
WhiteText("Personal matter: ") : ColorText(BeingType2Name(\Hatred))
If ParaTroop(*Being) : WhiteText("Vertoposition range: ")
Else : WhiteText("Transposition range: ") : EndIf ; Ñòàíäàðòíàÿ íàäïèñü.
ColorText(Amount2Str(\SpawningRange, *Being)) ; Ïèøåì äàëüíîññòü.
Else ; -Ñòàíäàðòíàÿ ðîñïèñü:
...
ClsColor_(80, 80, 80) : Cls_() : PrettyBox(#TableWidth, #TableHeight) ; Òåïåðü ñàì òåêñò:
...
Define I, G ; Ñ÷åò÷èêè.
For G = 0 To 1 ; Ïîäãîòîâêà ñïåö. ãðàôèêè
...
If G : Player2Color(I, #False) ; Òðåáóåòñÿ äîï. ãðàôèêà:
...
Player2Color(Player, 0) ; Còàâèì öâåò ðàìêå.
...
Plot_(#ConnRect, 0) : Plot_(#ConnRect + #RectWidth - 1, 0) ; ...È ïîñëåäíåå:
...
X + XSpeed : Y + YSpeed ; Ñäâèã ïî ñêîðîñòÿì.
...
Define I, SColor, TColor ; Àêêóìóëÿòîðû.
UseBuffer(*Buffer) : Plot_(Start, Start) 
SColor = ReadPixel_(Start, Start, *Buffer)
WritePixel_(Start, Start, 0, *Buffer) ; Íà âñÿêèé ïîæàðíûé.
Define R = Red(SColor)   ; Êðàñíûé.
Define B = Blue(SColor)  ; Ñèíèé.
Define G = Green(SColor) ; Çåëåíûé.
For I = 1 To Shift : StepBlock(Border, Start) : Next I
For I = 3 To Limit ; Ðèñóåì ñàì áëîê:
Define TColor = RGBA(R, G, B, 255 * (0.0 + I / Limit))
WritePixel_(X, Y, AlphaBlend(TColor, #TrueBlack), *Buffer)
StepBlock(Border, Start) ; Ïðîäîëæàåì øàã.
Next I
EndProcedure

Macro DrawMomentum() ; Partializer.
Define Frame = 0, Time ; Ïåðåìåííûå.
For I = 0 To #MaxPlayers : Player2Color(I, Int(Sign(I)) ! 1)
For Time = 1 To #MaxMomentum ; Ðèñóåì âîðòåêñ:
...
SetOn(System\SwitchSymbol, \Entity) ; Âûñòàâëÿåì.
...
Default : RotatorPart() ; Ñòàíäàðòíîå âðàùåíèå.
EndSelect
EndWith
EndProcedure
...
For Pixel = 1 To System\Level\Width ; Ñêàíèðóåì êàæäóþ ëèíèþ.
For Line = 1 To System\Level\Height ; Íà êàæäûé ïèêñåëü...
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If *Ptr\CellType = #pIgnorance       ; Îñâåùåíèå:
EntityColor_(GetParent_(*Ptr\Entity), Light, Light, Light)
EndIf : *Ptr + SizeOf(Square)        ; Ñòàíäàðòíîå ñìåùåíèå.
Next Line : *Ptr + Offset            ; Ïîëíîå ñìåùåíèå.
If Oddity = 0 : Flag = ~Flag : EndIf ; Ïîïðàâêà.
Next Pixel
EndProcedure

Macro UpdateRotors() ; Pseudo-procedure
Define Speed = 3, Light ; Èçíà÷àëüíûå ïàðàìåòðû...
...
EntityColor_(System\GUI\Rotors(), Light, Light, Light) ; Åùå è ïîäñâå÷èâàåì äëÿ êðàñîòû.
Next
EndMacro
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
With *Being ; Äîëãàÿ è íóäíàÿ íàñòðîéêà:
\Vision = CopyEntity_(System\VisionMesh, \EyePoint)
ScaleEntity_(\Vision, #OutRing, #RingHeight, #OutRing) : ApplyVision(\Vision)
TranslateEntity_(\Vision, 0, #VisionLuft, 0) ; Íåáîëüøîå ñìåùåíèå.
Define *Vision2 = CopyEntity_(\Vision) ; Åùå îäíî êîëüöî.
...
HideEntity_(\Vision) ; Ñðàçó ñêðûâàåì.
EndWith
EndProcedure
...
If RecarnType(Type) : \Reincarnated = #True ; Óñòàíîâèòü ôëàã ðåèíêàðíàöèè.
ElseIf Type >= #BSeer : \Ascended = #True : \SpawningCost = #All : \SwapPost = \Posterity: EndIf ; Óñòàíîâèòü ôëàã âîçíåñåíèÿ.
...
SetAnimTime_(\Entity, 0) : FindParts(*Being) ; Ïîèñê ñïåö. ÷àñòåé íà àíèìàöèþ.
; -Shield setup-
\Shield = Being2Shield(*Being) ; Ïîëó÷àåì ñîáñòâåííûé ùèò.
If \Shield : \Shield = CopyEntity_(\Shield, \Entity) : EndIf
If \Reincarnated : \Shocker = CopyEntity_(\Shield, \Entity) 
\ShockTex = CloneTexture(System\ShockTex) ; Øîêåð.
ComplexEntityTexture(\Shocker, \ShockTex) ; Øîê.
EndIf
; -Turn around-
TurnBeing(*Being, DeltaYaw_(\Entity, System\Sky) - 180)
; -Cryogene setup-
\CryoTex = CloneTexture(System\CryoTex)
TextureBlend_(\CryoTex, 0) ; Èçíà÷àëüíàÿ íåâèäèìîñòü.
...
With *Being
\Square\Being = #Null ; Ñòèðàåì çàïèñü íà êëåòêå.
FreeImage_(\Table) : FreeImage_(\DataBoard) : FreeEntity_(\Entity) : FreeTexture_(\CryoTex)
If \SpecialTex : FreeTexture_(\SpecialTex) : EndIf ; Îñâîáîæäàåì ñïåöèàëüíóþ òåêñòóðó.
If \SpecialTex2 : FreeTexture_(\SpecialTex2) : EndIf ; Îñâîáîæäàåì ñïåöèàëüíóþ òåêñòóðó 2.
If \SpecialTex3 : FreeTexture_(\SpecialTex3) : EndIf ; Îñâîáîæäàåì ñïåöèàëüíóþ òåêñòóðó 3.
If \SpecialTex4 : FreeTexture_(\SpecialTex4) : EndIf ; Îñâîáîæäàåì ñïåöèàëüíóþ òåêñòóðó 4.
If @System\Beings() = System\GUI\ActiveBeingPos And ListSize(System\Beings()) > 1
Define *ListPos = @System\Beings() ; Ñîõðàíÿåì ïîçèöèþ.
If PreviousElement(System\Beings()) = #Null : LastElement(System\Beings()) : EndIf
System\GUI\ActiveBeingPos = @System\Beings() ; Ïîëó÷àåì íîâóþ àêòèâíóþ Ñóùíîñòü.
ChangeCurrentElement(System\Beings(), *ListPos) ; Âîçâðàùàåì ïîçèöèþ
EndIf : DeleteElement(System\Beings()) ; Óäàëÿåì, íàêîíåö, Ñóùíîñòü.
EndWith
EndProcedure

Procedure FormRect(*Rectangle.Rect) ; Left = X öåíòðà, Top = center Y öåíòðà, Right = ðàäèóñ.
Define Range
With *Rectangle
Range = \Right
\Right = \Left + Range
...
If ParaTroop(*Being) ; Åñëè èìååì äåëî ñ ïðûæêîì.
...
Else ; Ðàçáèðàåïìñÿ ñî ñëó÷àÿìè ïî-ïðîùå.
...
If DelayTargeting(*Being) ; Åñëè ìû èìååì äåëî ñ Seer'îì â ïîçå...
...
With *Being ; Äëÿ íà÷àëà îïðåäåëåÿåì ðàäèóñ è òèï äåéñòâèÿ:
...
HLRect\Right = Range : FormRect(HLRect) ; ...À òåïåðü ñêàíèðóåì...
...
*Square = Squares(X, Y) ; Ïîäñâå÷èâàåì, åñëè äåéñòâèå äîïóñòèìî:
...
; SM = 0 - Îáû÷íûé ïîèñê.
; SM = 1 - Ïîèñê èíôèöèðîâàííûõ Ñóùíîñòåé.
; SM = 2 - Ïîèñê Ñóùíîñòåé äëÿ òàáëèöû îïàñíîñòåé.
...
EndIf ; Îñòàâëÿåì òîëüêî ïðîñòóþ ïîäñâåòêó.
...
If System\GUI\Ghost\Entity : HideEntity_(System\GUI\Ghost\Entity) : EndIf ; Ñðàçó óáèâàåì.
System\GUI\Ghost\Type = Being\Posterity ; Ïðèçðàê.
...
With *Being ; Îáðàáîòêà Ñóùíîñòè...
\InterState = #True ; Ôëàã ïåðåìåí.
...
If *Being\DelayedBlow ; Åñëè ãîòîâèòñÿ îòëîæåííûé óäàð...
...
; ...Åñëè êëåòêà ïîïàäàåò â îáëàñòü àáñîðáöèè...
If (Abs(X - \Square\ArrayPos\X) + Abs(Y - \Square\ArrayPos\Y)) <= \AbsorbtionRange
*Sqr = Squares(X, Y)
If EntityVisible_(\EyePoint, *Sqr\Entity) ; Åñëè îíà âèäèìà...
; Âûñòàâëÿåì óðîâåíü îïàñíîñòè.
...
; ...è äëÿ ðåèíêàðíàòîâ...
If \Reincarnated ; Ðåèíêàðíàò íà ðåèíêàðíàòà.
...
SetHatred(*Sqr, \Hatred) ; Íåíàâèñòü, íåíàâèñòü, íåíàâèñòü !
Else : *Sqr\DangerLevel4Reincarnates + \AbsorbtionCount / 2 * Reverse
EndIf ; Âûñòàâëÿåì óäâîåííûé óðîâåíü îïàñíîñòè:
EndIf
; Êîððåêòèðîâêà óðîâíÿ îïàñíîñòè ñ ó÷åòîì êàíàëîâ...
If FC > 0
*Sqr\DangerLevel + #ChannelsFlow * Reverse
*Sqr\DangerLevel4Reincarnates + #ChannelsFlow * Reverse
; Çàïèñü èíôîðìàöèè î çàìîðàæèâàþùèõ Ñóùíîñòÿõ...
...
TextureBlend_(Being\CryoTex, 5) ; Ïîëóîòòàÿííîå ñîñòîÿíèå.
EndMacro

Procedure ApplyFroze(*Being.Being, Duration)
With *Being
If Duration > \Frozen ; Ðàçóìíàÿ ïðîâåðêà.
FreezeAnim(*Being) : \Frozen = Duration ; Ñàìîå ãëàâíîå.
If \State = #BActive : DeActivateBeing(*Being) : EndIf ; Êàçàëîñü áû. Íî...
...
If PeekHeight(X + XShift, Y + YShift) = Height ; Íà÷èíàåì.
...
Select *Being\Type ; Íå äëÿ âñåõ...
Case #BFrostBite ; Êðèîáîìáà.
; Ëîãè÷åñêàÿ ÷àñòü.
WideFroze(*Being)
; Âèçóàëüíàÿ ÷àñòü.
...
FreeEntity_(Being\DelayedBlow\TPiv) ; Òîæå îñâîáîæäàåì.
...
ClearBlow(*Victim)
\State = #BDying
If \StoreLink <> #NoLink : StoreCell(\StoreLink) = #Null : \StoreLink = #NoLink : EndIf ; Óäàëÿåì ïðèâÿçêó ê êëàâèøå.
...
With *Being ; Âñåñòîðîíÿÿ îáðàáîòêà.
If *Being ; Åñëè ìû ëèíêóåì íå íîëü.
Select \StoreLink ; Äåéñòâóåì ïî ñèòóàöèè.
Case #NoLink : If StoreCell(LinkNum) : StoreCell(LinkNum)\StoreLink = #NoLink : EndIf
Case LinkNum : ProcedureReturn ; Íå òðåáóåòñÿ, ïðîñòî èç ïðîöåäóðû âûõîäèì.
Default ; Íóæåí îáìåí ãðóïï - ñàìîå ãëþ÷íîå (îáû÷íî)...
Swap StoreCell(LinkNum), StoreCell(\StoreLink) ; Îáìåí óêàçàòåëåé. À òåïåðü è íîìåðîâ:
If StoreCell(\StoreLink) : StoreCell(\StoreLink)\StoreLink = \StoreLink : EndIf
EndSelect : \StoreLink = LinkNum    ; Ðåëèíêîâêà. Íó à åñëè ìû ëèíêîâàëè 0...
ElseIf StoreCell(LinkNum) : StoreCell(LinkNum)\StoreLink = #NoLink ; Îáíóëåíèå.
EndIf : StoreCell(LinkNum) = *Being ; Íà âñÿêèé ñëó÷àé.
EndWith
EndProcedure
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Select \Square\CellType ; Âûáèðàåì òèï ïîêðàñêè...
...
Procedure AnimateReincarnation(*RE.ReincEffect) ; Äîäåëàòü !
#RTubeStep = 0.5
...
ElseIf \State = #BActive ; Ñòàâèì âîðòåêñ.
If MindInfected(*Being) : *Table\Momentum = \Momentum >> #MomentShift
*Table\Momentum = #Mirror - \Momentum >> #MomentShift ; ...èëè ñòàíäàðòíûå öâåòà:
...
If *Table\Attention : *Table\Attention + #MaxPlayers : EndIf ; Ñïåöèàëüíàÿ ðàìêà.
EndIf
...
; Mode = 0 ; Ñòàíäàðòíàÿ ïðîâåðêà.
; Mode = 1 ; Ïðîâåðêà ïî ïîëíîé ýíåðãèè.
; Mode = 2 ; Ïðîâåðêà íà áóäóùóþ ðåèíêàðíàöèþ.
With *Square
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If Not Unfreezable(*Being) ; Åñëè Ñóùíîñòü âîîáùå ìîæåò áûòü çàìîðîæåíà...
...
ProcedureReturn #True : ElseIf \AdvFrozers : ProcedureReturn #True ; Äà, çàìîðîçêà - ýòî ïëîõî.
ElseIf Random(\Biters*FactorEX)>\Biters    : ProcedureReturn #True ; Frostbite'û - òîæå.
EndIf
EndIf
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
With *Absorber
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If Sacr=#False And \Ascended And *Victim\Reincarnated ; Ïîëåòÿò êëî÷êè ïî çàêîóëî÷êàì...
...
If \AbsorbtionCount = #All ; Åñëè äîëæíû âçÿòü âñå....
AbsorbtionCount  = #AllReplacer                   ; ...Áåðåì íå âñå.
Else : AbsorbtionCount = \AbsorbtionCount / 2     ; ...Èíà÷å áåðåì ïîëîâèíó.
EndIf
Else : AbsorbtionCount = \AbsorbtionCount         ; Áåðåì êàê ïîëîæåíî.
EndIf
EndIf ; Ïðîäîëæàåì íàøè ðàñ÷åòû:
If AbsorbtionCount <> #All ; Åñëè íå äîëæíû âçÿòü âñå...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Else ; ...Åñëè èíôåêöèÿ íå ðàññìàòðèâàåòñÿ....
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
ElseIf Sacrificer(*Victim) = #False ; Ïîèñê îïòèìàëüíîé öåëè äëÿ ïåðåäàò÷èêîâ ýíåðãèè:
; ------------------------------------------
Define F = \AbsorbtionCount ; Äàáû óêîðîòèòü ôîðìóëû.
If EnablesReincarnation(*Victim, F) And CheckDeadlyDanger(*Victim, *Victim\Square, 2, F) = #False
ProcedureReturn #True : EndIf ; Ñêàæåì "äà", åñëè öåëü ìîæåò ðåèíêàðíèðîâàòü.
If CheckDeadlyDanger(*Victim, *Victim\Square, 1, F) = #False And EnablesReincarnation(*OldFavorite, F) = #False
If EnablesSpawning(*Victim, F) : ProcedureReturn #True ; Ñêàæåì "äà", åñëè ïîìîæåì ðàçìíîæåíèþ.
ElseIf EnablesSpawning(*OldFavorite, F) = #False And *Victim\ReincarnationCost > 0
F = *OldFavorite\ReincarnationCost - *OldFavorite\EnergyLevel ; Ïåðåñ÷åò.
If *OldFavorite\ReincarnationCost <= 0 Or *Victim\ReincarnationCost - *Victim\EnergyLevel < F
ProcedureReturn #True ; Ñêàæåì "äà", åñëè ïîìîæåì ðåèíêàðíàöèè.
EndIf
EndIf
EndIf
; ------------------------------------------
...
Next I
If Advanced ; Åñëè åùå íóæíî êîëüöî...
For I = 1 To 200 : SpawnShiver(*Shiver)
...
Next I
Next Dir
If Target = #BHunger ; Åñëè èìååì äåëî ñ ëþáèìûì...
For Dir = 1 To 4 ; Åùå ðàç ïî ñòîðîíàì....
...
Next I
Next Dir
Else ; Ïðîñòî íåáîëüøîé ñòîëáèê ãàçà:
...
Case 0 : Being\Layer#Blink = 1 ; Åñëè ùèò íå àêòèâåí - àêòèâèðóåì.
Case 1 To #HalfBlink        ; NOP. Èíà÷å ñáðàñûâàåì îáðàòíî:
...
Select Color ; â çàâèñèìîñòè îò öâåòà...
...
With *Victim ; Ðàáîòàåì ñ îïïîíåíòîì.
Select \Type ; Âûáèðàåì ïî òèïó.
Case #BJustice : FancyBlow(\Square) : BlowSquare(\Square) : HideEntity_(\Square\Projection) ; Ëó÷è.
Case #BJinx : Define I, ToFix = 300 : For I = 1 To ToFix ; Ñîçäàåì îñêîëêè.
Define *Shard.Shard = SpawnShard(-Random(#White), #ShardTime/2.75, 5) : SetOn(*Shard\Entity, \Square\Entity) 
RotateEntity_(*Shard\Entity, -90, Random(4)-2, Random(4)-2) ; Ëåòÿò ââåðõ. Ôîíòàíîì.
...
*Shard\Parented = 2 : *Shard\Parent = \Square\ArrayPos ; Ïèøåì ôëàãè.
...
\Flash = #MaxFlash ; Ýôôåêò âñïûøêè îò àáñîðáöèè.
...
Else : Factor = 0
EndIf
; ^Åñëè åñòü èíôåêöèîííûå êàíàëû è æåðòâà ìîæåò áûòü èíôèöèðîâíà, ïðèíàäëåæà ïðè ýòîì äðóãîìó èãðîêó...^
...
; ^Åñëè èíôåêöèîííûé êàíàë íàéäåí è ïðèãîäåí...^
; Ïåðåíîñèì êàíàë.
...
Next
EndIf
; Ñîáñòâåííî, ïåðåêà÷êà.
DeActivateBeing(*Absorber)
If Sacrificer(*Absorber) = #False
If *V\Reincarnated And *Absorber\Ascended ; Åñëè ó íàñ êîíôëåêò ïðèíöèïîâ...
If *V\Type = *Absorber\Hatred : DrainAmount = #All : FinishingBlow(*Absorber, *V) 
Else : DrainAmount = \AbsorbtionCount * 2 : EndIf ; Ïðîñòî ëóïèì â 2 ðàçà ñèëüíåå.
EnableLayer(*V, Shocker) : *V\LockDown = 2        ; ...È ëîìàåì îïòèêó.
Else ; Èíà÷å ïðîäîëæàåì êàê îáû÷íî:
If (*V\Reincarnated Or Ignorant(*V)) And (\Reincarnated = #False And \Type <> #BEnigma)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If *V\Shield ; Êèäàåì íà ùèò, åñëè åñòü.
EnableLayer(*V, Shield) : EndIf ; Ïðîäîëæàåì òðàíçàêöèþ:
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If \AbsorbtionCount = #All
...
With *Seer ; Îáðàáîòêà Seer'à.
\BlowPos = *Square\ArrayPos
\DelayedBlow = *Square      ; X-link.
*Square\DelayedBlow = *Seer ; X-Link.
FancyBlow(*Square) ; Ãðàôèêà.
EndWith
If Lazy = #False ; Åñëè íå âîññòàíàâëèâàåìñÿ èç Save'à.
DeActivateBeing(*Seer) ; Ñðàçó ñíèìàåì äåéñòâèå.
System\GUI\SelectedBeing = #Null
EndIf
EndProcedure
...
BlowSquare(*Target) ; Ñðàçó ñòàâèì àíèìàöèþ.
If *Target\Being : *Victim = *Target\Being
If *Victim\State <> #BDying ; Åñëè òàì åùå ÷òî-òî åñòü...
...
\Type = Type   ; Çàïèñûâàåì íà áóäóùåå.
\X = *Square\ArrayPos\X
\Y = *Square\ArrayPos\Y
\Angle = Angle ; Êýø óãëà.
EndWith
...
With *Flector ; Äàëüíåéøàÿ îáðàáîòêà.
For Y = 1 To 12
...
*Ride = System\Rides() ; Ñèòàåì íîâîñîçäàííîå....
With *Ride ; Îáðàáîòêà ýêñïðåññà.
\ColorMode = Mode ; Ðåæèì ðàñêðàñêè.
...
With *Being1 ; Ïðîñòî äëÿ óäîáñòâà.
Swap \X, *Being2\X ; X-ïîçèöèÿ.
Swap \Y, *Being2\Y ; Y-ïîçèöèÿ.
...
RidingFlex(*Destination) ; Êîìïðåññîð (ñòàíäàðò èëè íåò).
...
With *Ride ; Íà÷èíàåì îáðàáîàòêó ïîåçäêè. Âåñü êîìôîðò:
If \Frame < #Expresstime : \Frame + 1 ; Ñ÷åò÷èê.
...
Color1 * (1 - SFactor) : Color2 * (1 - SFactor) ; Àëüôà.
...
Else : SFactor = 0
EndIf
If \Compressed ; È íèêàêèõ êîìïðîìèññîâ.
...
; Öâåòà, òåêñòóðû, ìóçûêà... À, ìóçûêà íå çäåñü.
...
CollapseHL() : FullHL(Desire) ; Îáëàñòü âûäåëåíèÿ.
SendEnergy(Desire\Square, FBite\Square, 1) ; Âðåìåííîå ðåøåíèå.
EndMacro
...
If \Ascended = #False ; Åñëè ðàçãîâîð íå èäåò îá Àñêåíäàíòàõ...
SendEnergy(\Square, *Child\Square, SentEnergy)
InvokeCrest(*TargetSquare, \Posterity, (*Child\EntityYaw - 45) / 90 * 90)
ElseIf *Child\Type = *Parent\Type : Size = Min(AnimLength_(\Entity) - 1, \AnimEdge) ; Êîððåêòèðóåì.
*Child\OnceAnim = ExtractAnimSeq_(*Child\Entity, AnimTime_(\Entity), Size, AnimSeq_(\Entity))
*Child\Temporary = AnimTime(*Parent)           ; Òî÷êà íà÷àëà âðåìåííîé àíèìàöèè.
SetAnimTime_(*Child\Entity, AnimTime(*Parent)) ; Òîæå ñòàâèì.
\Transfert = #True : *Child\Transfert = #True   ; Ñïåö. ôëàãè.
Flectorize(*Parent\Square, *Parent\Type) : Flectorize(*Child\Square, *Child\Type)
*Child\Special = *Parent\Special : *Child\SynthCores = *Parent\SynthCores ; Íà âñÿêèé ñëó÷àé. 
ElseIf *Child\Type = #BFrostBite : FuseBite(*Parent, *Child)
EndIf ; ...Òåïåðü ñòàíäàðòíîå ðàçâèòèå ñîáûòèé:
If GoOn = #False : System\GUI\SelectedBeing = #Null ; Ñíèìàåì âûäåëåíèå.
...
With *Being
If CheckDeadlyDanger(*Being, \Square, 1) ; Åñëè íàõîäèòüñÿ íà êëåòêå îïàñíî.
...
; Ïûòàåìñÿ íàéòè ïðèãîäíîãî äëÿ àáñîðáöèè âðàãà...
; Ôîðìèðóåì çîíó ïîèñêà.
...
If *FB ; Åñëè íà íåé êòî-òî åñòü...
If CheckOwner(*Absorber, *FB, Inf) And Existing(*FB) And *FB <> *Absorber
; ^Åñëè ýòîò êòî-òî - ÷óæîé èëè çàðàæåí...^
If *Favorite ; Åñëè óæå åñòü õîòü îäíà íàìå÷àåìàÿ öåëü...
If Not Boring(*FB) ; Åñëè íàéäåí ÍÅ íåéòðàë...
If Boring(*Favorite) Or CheckFavorite(*Absorber, *FB, *Favorite, Inf, Sacr)
; ^Åñëè íàéäåííàÿ ñóùíîñòü ïîäõîäèò äëÿ àáñîðáöèè ëó÷øå...^
*Favorite = *FB ; Èçìåíÿåì íàìå÷åííóþ öåëü.
EndIf
EndIf
Else : *Favorite = *FB ; Âûñòàâëÿåì ïåðâóþ öåëü.
EndIf
EndIf
EndIf
EndIf
EndIf
Next X
Next Y ; Âîçâðàùàåì ðåçóëüòàò:
If *Favorite ; Åñëè õîòü ÷òî-òî íàøëè...
If Inf = #False :  If *Favorite\Type = #BFrostBite : Score = BiteScore(*Favorite, *Absorber\Owner)
If Score < 0  : ProcedureReturn #Null : EndIf : EndIf ; Ëó÷øå òàê, ÷åì íèêàê.
If *Favorite\Owner = 0 And *Favorite\EnergyLevel < 5 And Score = 0 And Random(1) : ProcedureReturn #False : EndIf ; Íà ñëó÷àé.
EndIf
...
; Ïåðåáèðàåì âåñü ñïèñîê Ñóùíîñòåé...
ForEach System\Beings()
*FB.Being = System\Beings()
If *FB ; Åñëè íà íåé êòî-òî åñòü...
If *FB\Owner And (Enemies(*Seeker\Owner, *FB\Owner) Or MindInfected(*FB)) ; Åñëè ýòà öåëü ïîäõîäèò...
Range = Abs(*FB\Square\ArrayPos\X - *Seeker\Square\ArrayPos\X)
Range + Abs(*FB\Square\ArrayPos\Y - *Seeker\Square\ArrayPos\Y) 
; ^Îïðåäåëÿåì ðàññòîÿíèå äî íàéäåííîé ñóùíîñòè^.
If *Favorite  ; Åñëè óæå åñòü õîòü îäíà íàìå÷àåìàÿ öåëü...
If Range < FavRange Or Random(20) = 0 ; Åñëè íàéäåííàÿ öåëü áëèæå íàìå÷àåìîé èëè ñëó÷àéíûé ïîðûâ...
FavRange = Range : *Favorite = *FB ; Èçìåíÿåì íàìå÷åííóþ öåëü.
EndIf ; Åñëè öåëè íåò:
Else : FavRange = Range : *Favorite = *FB ; Âûñòàâëÿåì ïåðâóþ öåëü.
EndIf
EndIf
EndIf
Next
...
FormRect(ScanRect)
; È èùåì îïòèìàëüíóþ ïîçèöèþ äëÿ ïåðåíîñà.
For X = ScanRect\Left To ScanRect\Right
For Y = ScanRect\Top To ScanRect\Bottom
...
If Range <= \AbsorbtionRange ; Åñëè öåëü ìîæíî ñðàçó àáñîðáèðîâàòü ñ ýòîé ïîçèöèè...
; Âûñòàâëÿåì ïîçèöèþ EyePoint'à.
SetOn(*EyePoint, *FSquare\Entity)
TranslateEntity_(*EyePoint, 0, EyePointHeight, 0)
If EntityVisible_(*EyePoint, *FSquare\Entity) ; Åñëè æåðòâà âèäèìà ñ ýòîé ïîçèöèè...
; Èçìåíÿåì íàìå÷åíóþ ïîçèöèþ è âûõîäèì èç öèêëà ïîèñêà.
*Favorite = *FSquare
Break 2
EndIf
EndIf
If CheckDeadlyDanger(*Parent, *FSquare) = #False ; Åñëè ýòî íå áåññìûñëåííûé ðèñê...
If *Favorite ; Åñëè óæå åñòü íàìå÷åííàÿ ïîçèöèÿ...
If Range < FavRange ; Åñëè áëèæå...
*Favorite = *FSquare : FavRange = Range ; Èçìåíÿåì íàìå÷åííóþ ïîçèöèþ.
EndIf
Else ; Åñëè ïîçèöèè íåò:
*Favorite = *FSquare : FavRange = Range ; Âûñòàâëÿåì ïåðâóþ ïîçèöèþ.
EndIf
EndIf
EndIf
EndIf
...
With *Being
Select Stage
Case 0 ; Ïåðåä êàêèìè-ëèáî äåéñòâèÿìè.
Select \Type 
Case #BEnigma ; NOP
Case #BAmgine
...
Else ; Èíà÷å ñòàíäàðòíàÿ àíèìàöèÿ...
Select \Type
...
For I = 1 To ToFix ; Ñîçäàåì îñêîëêè.
Define *Shard.Shard = SpawnShard(SColor)
If *Being\ExtraMode ; Èñêðû ñ çåìëè.
...
With *Desire ; Îáðàáàòûâàåì...
Define Alpha.f, I, ToFix = CountChildren_(\SpecialPart2) - Factor, *ThatCore
; Îáðàáîòêà êàæäîãî ÿäðà. Ïîòîì íåêîòîðûå ïðåòåðïÿò èçìåíåíèÿ, íî òî ïîòîì.
Define  Limit = \SynthCores                 ; Äëÿ íåáîëüøîãî óïðîùåíèÿ.
If \Special < 0 : Limit + 1 : EndIf         ; Êîððåêòèðîâêà. Ïîêà òàê.
For I = ToFix - #MaxCores + 1 To ToFix
Define *Child = GetChild_(\SpecialPart2, I) ; Ïîëó÷àåì óêàçàòåëü íà ÿäðî.
If Limit : Alpha = \StateFrame : Limit - 1  ; Äåëàåì ÿäðî âèäèìûì.
If Limit = 0 : *ThatCore = *Child : EndIf   ; Çàïîìèíàåì ïîñëåäíåå ÿäðî.
Else : Alpha = 0 : EndIf                    ; Äåëàåì ÿäðî íåâèäèìûì.
...
Next I
; Îáðàáîòêà îãðàíè÷èòåëÿ êàäðîâ...
If \Special < 0 ; Åñëè èäåò çàäåðæêà ñ ãåíåðàöèè íîâîãî ÿäðà...
If \Special < -1 : \Special + 1 : Else : \Special = 0 : \SynthCores + 1 ; Îáíóëåíèå òàéìåðà.
UpdateDesireDesc(*Desire) : EndIf
ElseIf \Special > 0 ; Åñëè èäåò çàäåðæêà ñ ñèíòåçà...
...
If \Special > #SynthStep : \Special - #SynthStep ; Ñíèæåíèå øàãà.
Else : \Special = 0 : \SynthCores - 1            ; Îáíóëåíèå øàãà.
UpholdCores(*Desire, Factor)                     ; Ñàìîâûçûâàåìñÿ, äàáû âñå ñêðûòü.                            
UpdateDesireDesc(*Desire)                        ; Óòî÷íÿåì, äà.
EndIf : EndIf
EndWith
EndProcedure
...
With *Desire ; Îáðàáàòûâàåì öåëåâóþ Ñóùíîñòü...
\Special = -(#CryoTime - #CoreFrame + #CoreLat)
If \SynthCores > -1 ; Åñëè òàì ÷òî-òî åñòü...
...
If \Interstate ; Åñëè âîîáùå òðåáóåòñÿ îáðàáîòêà...
If \ExtraMode = #False ; Åñëè âèíòû èñ÷åçàþò...
AFactor = \StateFrame * (1 - ((AnimTime - \AnimEdge) / 10))
If AnimTime = \AnimEdge + 15 : HFactor = 1 : EndIf ; Ïîêàçàòü òðóáû.
Else ; Åñëè âèíòû òàêè ïîÿâëÿþòñÿ...
AFactor = \StateFrame * ((AnimTime - \AnimEdge - 20) / 10)
If AnimTime = \AnimEdge + 15 : HFactor = 2 : EndIf ; Ñêðûòü òðóáû.
EndIf : Else ; Òåïåðü ïðîâåðÿåì ñïåöèàëüíûå ñëó÷àè...
If \ExtraMode And (Forced Or Not Existing(*Desire)) : AFactor = 0 : EndIf
If \ExtraMode And Forced : HFactor = 1 : EndIf 
EndIf ; Òåïåðü âåðøèì ïðåäíà÷åðòàííîå ïî àëüôå:
If AFactor >= 0 And AFactor <= \StateFrame ; Ëîãè÷åñêàÿ ïðîâåðêà.
ComplexEntityAlpha(\SpecialPart4, AFactor) : ComplexEntityAlpha(\SpecialPart5, AFactor)
EntityAlpha_(\SpecialPart2,\StateFrame) : ComplexEntityAlpha(\SpecialPart2,\StateFrame) ; Òàê íàäî.
EntityAlpha_(FindChildSafe(\Entity, "Hatchery_Blend"), \StateFrame) ; Òîæå íàäî.
EndIf
; ...È ïî òðóáàì:
If HFactor = 1     ; Åñëè íàäî ïîêàçàòü òðóáû...
For I = 1 To #VicHolez : ShowEntity_(FindChildSafe(\Entity, "Tubus" + RSet(Str(I), 2, "0"))) : Next I
ElseIf HFactor = 2 ; Åñëè íàäî ñêðûòü òðóáû...
...
Define LoopFlag ; Äëÿ óïðîùåíèÿ àëãîðèòìà.
With *Being ; Îáðàáàòûâàåì...
If \Alpha <> System\Options\OmniAlpha  : BeingAlpha(*Being, System\Options\OmniAlpha) : EndIf
If Animating_(*Being\Entity) ; Òîëüêî åñëè àíèìèðóåìñÿ....
; ×òî äëÿ âñåõ:
If \Interstate ; Ñïåöèàëüíàÿ ïðîâåðêà.
...
EntityColor_(\SpecialPArt, Factor, Factor, Factor) ; Ìåðöàåì.
PositionTexture_(\SpecialTex, Random(200) / 100.0, Random(200) / 100.0)
Case #BParadigma ; Áàáî÷êè, áàáî÷êè...
...
Select AnimTime / ColorPie ; Îêðàñêà ïîçâîíî÷íèêà.
...
EndIf : EndIf : ParaRain(Color) : EndIf ; Íåìíîãî äîæäÿ íà ãðåøíóþ çåìëþ.
Case #BDesire : #TubeShivers = 25.0 : #TubeAngle = 45.0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Define ToFix, I, Advanced, *Source.Square = \Square, *Shiver.Shiver
Define AnimTime = AnimTimeEX(*Being)
If \ExtraMode = #False And AnimTime <= \AnimEdge ; Ñòàíäàðòíûé âûáðîñ êðèîãåíà.
...
Next I
EndIf
; Äàáû ßäðà îòîáðàæàëèñü íà ñèëóåòå...
...
ParaRain(\Frozen, 4) ; Ëåäÿíîé äîæäü.
EndIf
EndWith
EndProcedure
...
Being\Layer#Blink + 1 ; Ïîäíèìàåì çíà÷åíèå ñ÷åò÷èêà.
...
\Transfert = #False ; Ñíèìàåì ôëàã íà âñÿêèé ñëó÷àé.
...
System\Level\ActivationFlag = #True ; Ôëàã çàäåðæêè AI.
...
Define ASF : ASF = System\GUI\ASFlashing ; Íåáîëüøîå ñîêðàùåíèå.
...
If \Interstate = #False ; Åñëè ñ íàñòðîåíèåì îïðåäåëèëèñü - âðàùàåì çíà÷îê.
...
RotateSprite_(System\SwitchSymbol, System\GUI\SwitchAngle) ; Ðàçâîðîò ñïðàéòà.
EndIf 
EndIf
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
; -Vision update-
If MindInfected(*Being) And \State <> #BDying ; Åñëè åñòü çàðàæåíèå...
If \StoreLink <> #NoLink : LinkBeing(#Null, \StoreLink) : EndIf
If \Sanity < #MaxSanity : \Sanity + 1 : AlphaVision(*Being.Being) : EndIf 
ShowEntity_(\Vision) : TurnVision(\Vision) ; Îòîáðàæåíèå è ïðîêðóòêà.
...
If Sacrificer(*Being) : Define LightLevel = #NoColor * Factor    ; Çàòåìíåíèå.
Else : LightLevel = #NoColor + #FlashDiff * (1 - Factor) : EndIf ; Çàñâåòëåíèå.
ComplexEntityColor(\Entity, LightLevel, LightLevel, LightLevel)  ; Ñòàâèì îñâåùåíèå.
EndIf
; -Shield update-
...
; --------------
Define *Shiver.Shiver = TShiver ; Àêêóìóëÿòîð.
If *Shiver\Latency : *Shiver\Latency - 1 : Else ; Âåäåì àíèìàöèþ.
...
With *Ladder ; Îáðàáîòêà.
If \Frame < #LadderTime ; Àíèìàöèÿ æå.
...
With *DBlow ; Îáðàáîòêà.
If \Frame < #BlowTime ; Àíèìàöèÿ æå.
...
Factor * 2.5 ; Äëÿ áóäóùåãî ìàñøòàáèðîâàíèÿ.
...
With *Flector ; Îáðàáîòêà.
If \Frame < #FlectorDance ; Àíèìàöèÿ æå.
...
With *Crest
If \Frame < #CrestShine ; Àíèìàöèÿ æå.
...
; Èùåì ïåðâûé êàíàë Defiler'à...
ForEach System\Channels()
*Channel = System\Channels()
If *Channel\Advanced : Break : EndIf ; Åñëè èíôåêöèîííûé êàíàë íàéäåí - âûõîäèì èç öèêëà.
Next
If *Channel ; Åñëè åñòü, äëÿ êîãî ñòàðàòüñÿ....
Owner = \Owner ; Çàïîìèíàåì ñòàðîãî õîçÿèíà...
\Owner = *Channel\Destination\Owner ; Âûñòàâëÿåì íîâûì õîçÿèíîì íàëîæèâøåãî èíôåêöèîííûé êàíàë.
*Victim = FindVictim4Absobtion(*Being.Being, #True)
\Owner = Owner ; Âûñòàâëÿåì ñòàðîãî õîçÿèíà.
If *Victim : AbsorbBeing(*Being, *Victim) : EndIf ; Åñëè æåðòâà íàéäåíà - àòàêóåì...
EndIf
EndIf
EndWith
EndProcedure
...
If System\Level\AIFrame >= System\Options\AIDelay ; Åñëè ñðàáîòàë ñ÷åò÷èê êàäðîâ...
System\Level\AIFrame = 0 ; Îáíóëÿåì åãî.
...
EndIf
Else : System\Level\AIFrame + 1 ; Èíêðåìåíòèðóåì çíà÷åíèå ñ÷åò÷èêà êàäðîâ.
EndIf
EndIf
EndProcedure
...
Procedure SaveMap(FName.S = #AutoSave) ; Äîäåëàòü !
...
; Çàïèñàòü ïîçèöèþ äëÿ âûäåëåíèÿ.
...
EndIf
EndIf
If \Frozen = 0 ; Íåò áîëüøå çàìîðîçêè.
...
TextureBlend_(\CryoTex, 0) ; Óáèðàåì èçìîðîçü.
EndIf
; Òóò æå ïðîâåðÿåì Lock-down.
If \LockDown : \LockDown - 1 ; Ñíèæàåì ôëàã.
AddBeing2UpdateList(*Being, MindInfected(*Being))
EndIf
EndWith
EndProcedure
...
Define *Elevator.Square ; Ïîëó÷àåì äàííûå áëîêà.
ForEach System\Elevators() : *Elevator = System\Elevators() ; Ïîëó÷àåì íàïðàâëåíèå:
If     *Elevator\Height = 1 : *Elevator\OwnData = #False ; Èíà÷å âíèç...
ElseIf *Elevator\Height = #MaxPlatformsScale : *Elevator\OwnData = #True
EndIf ; Òåïåðü îáðàáàòûâàåì ñàìî ñìåùåíèå.
If *Elevator\OwnData : *Elevator\Height - 1 : Else : *Elevator\Height + 1 : EndIf
Next
EndMacro
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Procedure NextTurn(SkipToActivation = #False)
If SkipToActivation = #False ; Åñëè ïåðåõîä íå èäåò îò ñàìîé çîíû...
...
If CheckTimeOut() ; Åñëè çàäà÷à ìèññèè íå áûëà äîñòèãíóòà âîâðåìÿ...
...
If System\Level\ServiceTime = #False ; Åñëè åñòü âðåìÿ íà ãëóïîñòè...
ForEach System\Beings()
*Being = System\Beings()
With *Being
If \Owner = System\Level\CurrentPlayer ; Åñëè ýòîò òîò, êòî íàì íóæåí:
If \Type=#BDesire And \SynthCores<#MaxCores And \State<>#BDying And \Special < = 0 : FreezeCore(*Being) : EndIf
If \DelayedBlow And \Frozen <= 1 : TriggerBlow(*Being, \DelayedBlow) : EndIf ; Óäàð ñ çàäåðæêîé.
...
; -Elevators update-
ForEach System\Elevators() : *Elevator = System\Elevators() ; Àíèìèðóåì ýëåâàòîðû.
If *Elevator\OwnData : Move = -#ElevationStep : Else : Move = #ElevationStep : EndIf
*Cube = GetParent_(*Elevator\Entity) ; Ìåø ñàìîãî áëîêà.
*Node = GetChild_(*Cube, 1)          ; Ìåø óçëîâ.
TranslateEntity_(*Cube, 0, Move, 0)  ; Ñäâèãàåì áëîê.
...
Enlight(*Elevator\Entity) : EndIf ; Îñâåùåíèå äëÿ ïîëíîòû êàðòèíû
TranslateEntity_(*Elevator\TubesPiv, 0, -Move, 0) ; Ñòàâèì òðóáû âíèç.
TranslateEntity_(*Node, 0, -Move, 0)              ; Ñòàâèì óçëû âíèç.
EntityColor_(*Cube, LightLevel, LightLevel, LightLevel) ; Íåìíîãî îñâåùåíèÿ.
ComplexEntityColor(*Node, LightLevel, LightLevel, LightLevel) ; Åùå ÷óòîê.
...
; -Height translation-
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If *Square\CellType = #pVanilla ; ñòàíäàðòíàÿ êîððåêòèðîâêà
TranslateEntity_(*Tube, 0, #InfiniteCell - #HalfCell - (#CellSize * Height) + (#CellSize * I), 0)
SetupBox(*Tube, *Tube) ; Äëÿ êîëëèçèé.
...
AddElement(System\GUI\Matrix()) : System\GUI\Matrix() = *Tube    ; Âíîñèì íà áàëàíñ.
TurnEntity_(*Tube, Random(180) + 0.1, Angle, 0)    ; Ðàçâîðîò äëÿ ìàòðèöû.
MoveEntity_(*Tube, 0, Random(#TubeQuant), 0) ; Íåáîëüøîé ñäâèã.
If Squares(X, Y)\CellType = #pVanilla ; Íåáîëüøèå ïîïðàâêè...
TranslateEntity_(*Tube, 0, #InfiniteCell + #HalfCell - #CellSize * (I + Squares(X, Y)\Height), 0)   ; Ñ ïîïðàâêàìè
Else : TranslateEntity_(*Tube, 0, -Squares(X, Y)\Height * #CellSize + #CellSize - #CellSize * I, 0) ; Áåç ïîïðàâîê.
EndIf
Next I
EndProcedure
...
; Î÷èùàåì èãðîâîå ïîëå.
XEnd = \Level\Width - 1 : YEnd = \Level\Height - 1 ; Ñ÷èòàåì ãðàíèöû.
...
UseBuffer(*Buffer) ; Óñòàíîâêà áóôôåðà.
With *Team ; Îáðàáîòêà êîììàíäû
...
Procedure LoadMap(FName.S = ":Random:", Unlock = #False) ; Äîäåëàòü !
With System
...
If FName = ":Random:" ; Îïðåäåëåíèå òèïà çàãðóçêè.
BeginDialog() ; Âêëþ÷èòü äèàëîãîâûé ðåæèì.
If MGRequester(Params) ; Ïîëó÷åíèå äàííûõ îò ïîëüçîâàòåëÿ.
FinishDialog() ; Çàêðûâàåì äèàëîã.
Random = #True ; Ñëó÷àéíàÿ ãåíåðàöèÿ.
Else : FinishDialog() ; Çàêðûâàåì äèàëîã.
ProcedureReturn #False
EndIf
Else ; Çàãðóçêà èç ôàéëà.
...
ProcedureReturn #False
EndIf
If ReadLong(0) ; Åñëè êàðòà ó íàñ èç ðåäàêòîðà...
; Òåïåðü ïðîâåðÿåì çàùèòíûé êîä:
FileSeek(0, ReadLong(0) + Loc(0)) ; Edition pass.
I = ReadLong(0) : If I : Code = Space(I) : ReadData(0, @Code, I) ; ×èòàåì çàùèòíûé êîä...
If Unlock = #False ; Åñëè íå ñòîèò óíèâåðñàëüíàÿ îòìû÷êà...
Code = InvalidatePass(Code) ; Ñðàçó æå, íà âñÿêèé ïîæàðíûé.
Select CodeRequester("", #UnlockMsg)
Case "" : CloseFile(0) : ProcedureReturn #False ; Ìèðíî âûõîäèì.
Case Code ; Nop. ïðîäîëæàåì çàãðóçêó.
Default   ; Íåïðàâèëüíûé ïàðîëü...
...
; -Çàíîâî âûñòàâèòü ïàðàìåòðû êíîïêè "êîíåö õîäà"-
...
; -Platform creation-
If Random ; Åñëè èäåò ñëó÷àéíàÿ ãåíåðàöèÿ....
; Ñëó÷àéíî âûáðàòü âûñîòó êëåòêè.
If Rnd(100) <= I : Scale = Rnd(#MaxPlatformsScale) : Else : Scale = 1 : EndIf
; --------
; Íåáîëüøàÿ ðàíäîìèçàöèÿ òèïà êëåòîê:
Define CT, ElevatorEdge = Params\ElevatorsPercentage
Select Random(100, 1)  ; 100% øàíñîâ.
Case 1 To ElevatorEdge : CT = #pElevator       ; Ýëåâàòîð
Case ElevatorEdge + 1 To ElevatorEdge + Params\IgnorancePercentage
*Cell\Gold = Random(3) : CT = #pIgnorance      ; Îáåëèñê
Default : CT = #pVanilla                       ; Ïëàòôîðìà.
EndSelect : *Cell\CellType = CT ; Ñòàâèì, íàêîíåö, êëåòêå ýòîò ñàìûé òèï.
; --------
Else ; Ñ÷èòàòü âûñîòó èç ôàéëà
...
Case #pVanilla ; Ñòàíäàðòíàÿ ïëàòôîðìà.
If *Cell\Gold : *Platform = \PlatformGold ; Ñ ïîçîëîòîé æå !
ElseIf Type : *Platform = \PlatformRed : Else : *Platform = \PlatformGreen : EndIf
*Platform = CopyEntity_(*Platform) ; Òàêè ñîçäàåì.
...
; -----
Case #pElevator ; Ýëåâàòîð.
If *Cell\Gold : *Platform = \ElevatorGold ; Ñ ïîçîëîòîé æå !
...
; Ñîåäåíèòåëüíûå òðóáû.
*Cell\TubesPiv = CreatePivot_(*Platform)
If *Cell\CellType = #pIgnorance ; Åñëè òðåáóåòñÿ êîððåêòèðîâêà.
RotateEntity_(*Cell\TubesPiv, 0, 0, 0) : EndIf
If *Cell\CellType <> #pElevator ; Òðóáû è ðîòîðû.
...
; --Players setup--
If Random
; Ñîçäàòü çàäàííûõ ïîëüçîâàòåëåì èãðîêîâ.
ReDim \Players.Player(Params\PlayersCount)
If Params\ExpertMode : System\Level\TeamsCount = 2    ; Âñåãî 2 êîìàíäû.
Else : System\Level\TeamsCount = Params\PlayersCount  ; !!!!Âðåìåííî!!!!
...
If I > 1 ; Çàäàòü òèï óïðàâëåíèÿ èãðîêîì.
*Player\IType = Params\ITypes[I - 2]          ; !!!!Âðåìåííî!!!!
...
FindColor(System\Teams(I), I) ; Íà ñëó÷àé âîéíû.
Next I ; Ïðîäîëæàåì ðàçãîâîð...
If \Level\HumanPlayers > 1 : \Level\MultiPlayer = #True
Else : \Level\MultiPlayer = #False : EndIf
Else ; Çàãðóçèòü äàííûå î èãðîêàõ èç ôàéëà:
ToFix = ReadLong(0)
ReDim \Players.Player(ToFix)
For I = 1 To ToFix
ReadData(0, \Players(I), SizeOf(Player))
Next I
; Çàãðóçèòü äàííûå êîììàíä èç ôàéëà...
ToFix = ReadLong(0) ; Êîëè÷åñòâî êîììàíä.
ReDim \Teams.Team(ToFix) ; Ìàññèâ.
For I = 1 To ToFix ; Îáðàáàòûâàåì êàæäóþ.
ReadData(0, \Teams(I), SizeOf(Team))
Next I ; Ïîä êîíåö ñîõðàíÿåì:
EndIf
; --Íàñòðîèòü ñ÷åò÷èêè Ñóùíîñòåé--
#CountersInter = 4
...
; -Beings-
If Random ; Ñëó÷àéíàÿ ãåíåðàöèÿ è ðàññòàíîâêà ñóùíîñòåé.
Define XStart, YStart, XStep, YStep, I
; Îïðåäåëåíèå äîïóùåííûõ íà êàðòó Ñóùíîñòåé.
NewList AllowedSquad.i()  ; Ñóùíîñòè, äîñòóïíûå äëÿ ôîðìèðîâàíèÿ âçâîäà.
NewList AllowedNeuter.i() ; Ñóùyîñòè, êîòîðûìè äîáèâàåòñÿ êàðòà.
ForEach Params\AllowedBeings()
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Define BeingType = Val("$" + MapKey(Params\AllowedBeings())), BeingRarity = Params\AllowedBeings() ; Ïîëó÷àåì íåîáõîäèìûå ïàðàìåòðû.
For I = 1 To BeingRarity ; Ïî íåñêîñëüêî âõîæäåíèé, äëÿ ÷èñòîòû ýêñïåðèìåíòà.
...
Next I
Next
; Óñòàíîâêà íà÷àëüíîãî íàáîðà Ñóùíîñòåé äëÿ èãðîêîâ.
...
ClearList(Waves())
Define *Wave.Wave
; Âûñòàâëåíèå ïëîùàäè äëÿ ðàññòàíîâêè.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Next I
; Ðàññòàíîâêà Ñóùíîñòåé.
ForEach Squad() : I = 0
ForEach Waves() : *Wave = Waves() : I + 1
SetAgain: : Define Gen ; Ïðîáóåì, ïðîáóåì.
...
Next
Next
; Ðàññòàíîâêà íåéòðàëüíûõ Ñóùíîñòåé.
...
EndIf
Next I
Else ; Çàãðóçêà äàííûõ î Ñóùíîñòÿõ èç ôàéëà
Define Being.Being, *CreatedBeing.Being
ToFix = ReadLong(0)
For I = 1 To ToFix
ReadData(0, @Being, SizeOf(Being))
;;;;;;;;;;;;
If Being\Sanity = #MaxSanity : Being\Sanity - 1 : EndIf ; Ìàëåíüêàÿ õèòðîñòü...
...
Else : *CreatedBeing\InterState = Being\Interstate ; Èíà÷å ñòàâèì ôëàæîê.
EndIf
If Being\Frozen : ApplyFroze(*CreatedBeing, Being\Frozen) : EndIf
If Being\LockDown : *CreatedBeing\LockDown = Being\LockDown : EndIf
SetAnimTime_(*CreatedBeing\Entity, Being\SeqFrame) ; Èíîãäà âûðó÷àåò.
*CreatedBeing\GonnaRide = Being\GonnaRide ; Î÷åíü âàæíûé ôëàã.
...
RotateEntity_(*CreatedBeing\Entity, 0, 0, 0) ; ...Íó è ïîñëåäíåå:
If *CreatedBeing\Type = #BDesire : UpholdScrews(*CreatedBeing, #True) : EndIf
TurnBeing(*CreatedBeing, Being\EntityYaw)
Next I
If \Level\CurrentTurn <> 0 : UpdateCounters() : EndIf ; Îáíîâèòü çíà÷åíèÿ ñ÷åò÷èêîâ Ñóùíîñòåé.
; Çàãðóçêà äàííûõ î êâàíòàõ èç ôàéëà.
...
SetOn(System\Camera, System\CamPiv)     ; Ñòàâèì â íà÷àëî.
MoveEntity_(System\Camera, 0, 0, -25 - #MinCameraDistance) ; Better view.
Else ; Ïîçèöèîíèðîâàíèå âûäåëåíèÿ è êàìåðû.
...
; Çàãðóçèòü äàííûå ìàòðèöû èç ôàéëà.
ForEach \GUI\Matrix() : *Ptr = \GUI\Matrix() ; Êîððåêòèðóåì ñìåùåíèÿ.
PositionEntity_(*Ptr, ReadLong(0), EntityY_(*Ptr), ReadLong(0))       ; Ïðîñòðàíñòâî.
RotateEntity_(*Ptr, ReadLong(0), EntityYaw_(*Ptr), EntityRoll_(*Ptr)) ; Óãëû.
Next
; -Çàãðóçêà èíôîðìàöèè î êàíàëàõ-
...
Next I
UpdateTables()
; -Çàãðóçêà èíôîðìàöèè î ýôôåêòàõ Ïåðåðîæäåíèÿ-
...
Select *Shiver\Parented ; Âûáèðàåì ïî òèïó....
...
EndSelect
Next I
; Çàãðóçêà èíôîðìàöèè îá îñêîëêàõ.
Define ToFix = ReadLong(0), *Shard.Shard, Shard.Shard
For I = 1 To ToFix ; C÷èòûâàåì.
ReadData(0, @Shard, SizeOf(Shard)) ; Ñàìè äàííûå.
...
Next I
; -Çàãðóçêà èíôîðöèè î äåôëåêòîðàõ-
...
Next I
; -Çàãóçêà èíôîðìàöèè î ëåñòíèöàõ-
...
Next I
; Çàãðóçêà èíôîðìàöèè î ñèìâîëèêå.
...
; Âûñòàâèòü ïîçèöèè äëÿ ïîèñêà àêòèâíûõ Ñóùíîñòåé.
LastElement(\Beings())
\GUI\ActiveBeingPos = @\Beings()
; -Óñòàíîâêà ñòàðòîâîãî ìåøà äëÿ ñèëóýòà (Tree)-
...
\Level\CurrentTurn = 1
NextTurn()
; -Ñîçäàòü èçíà÷àëüíóþ ìàññó èñêð-
WipeSparksOut()
...
If System\Options\NoiseFilter Or System\Options\InstableOut ; Ïîêà òàê.
#MixerRange = 12
...
*GfxData = *GfxData\I ; Ñ÷èòûâàåì àäðåñ áóôôåðà.
If System\Options\NoiseFilter ; Ïðîâåðÿì çäåñü. Ïîêà çäåñü.
For I = 1 To Amount
...
Player2Color(0, 1) ; Äëÿ ôèîëåòîâûõ òî÷åê.
...
ElseIf \Momentum <> -1 ; Åñëè íóæíî ðèñîâàòü âîðòåêñ:
...
System\GUI\WaitVideo = #True ; Îïòèìèçàöèÿ.
AltLockMutex(System\VideoMutex)
System\GUI\WaitVideo = #False ; Ñòàâèì îáðàòíî.
*Buffer = FrontBuffer_()
LockBuffer_(*Buffer)
...
Select Event ; Àíàëèçèðóåì ñîáûòèå...
Case #WM_SETFOCUS, #WM_KILLFOCUS : MouseZSpeed_()
Case #WM_CLOSE : System\GUI\Exit = #True : ProcedureReturn ; Âûõîä áåç îáðàáîòêè.
EndSelect
...
Define Diagnose.s
Select ErrorCode() ; Îïðåäåëÿåì ïðè÷èíó.
...
; -System init-
SetHint("try with Win98 compatibility mode") ; Èíñòðóêöèÿ ê äåéñòâèÿì.
While CreateMutex_(0, 0, "=[Flow.Gaem]=") = #Null : Delay(100) : Wend ; Èäåíòèôèêàòîð.
If GetLastError_() : ErrorBox("Flow is already running !" + #CR$ + "Press 'OK' to exit.") : End : EndIf
Define FixDir.s = GetPathPart(ProgramFilename()) ; Íà ñëó÷àé cmd è òîìó ïîäîáíîãî.
...
; -Node cubes-
System\NodeCubes = CreatePivot_() ; Èçíà÷àëüíîå êðåïëåíèå.
...
ComplexEntityTexture(System\NodeCubesGold, System\PlatformEdgesTex[2]) ; Òîæå òåêñòóðèðóåì.
; -Relative resizing-
...
For I = 1 To 4 ; Åùå íåìíîãî àëüôû.
...
InvokeCrest(Square, #BParadigma) ; Òèõî âûçûâàåì...
System\ExpressCrest = CopyEntity_(System\GUI\Crests()\Entity)
FreeEntity_(System\GUI\Crests()\Entity) ; ...Óáèðàåì...
FreeEntity_(Square\Entity) : ClearList(System\GUI\Crests())
HideEntity_(System\ExpressCrest) ; ...È ñêðûâàåì.
; --Setup camera--
...
; --Options--
If OpenOptionsFile() = #False ; Åñëè íå óäàëîñü çàãðóçèòü íàñòðîéêè...
...
System\MAxFPS   = #MenuFPS ; Çàãëóøêà.
...
AltLockMutex(System\VideoMutex)
If System\GUI\Noised = 0 ; Åñëè íåò çàøóìëåíèÿ...
RenderWorld_()
...
Define *Square = *Target\Entity ; Ïîëó÷àåì îáëàñòü.
DynamicNoise(*Square) : PositionEntity_(System\CamPiv, TakeX(*Square), 0, TakeZ(*Square))
SetOn(System\Selection, *Square) ; Ïîñòàâèòü âûäåëåíèå.
...
Select System\GUI\Input
Case #PB_MB_Left
If *PSquare ; Åñëè âûäåëåíà êëåòêà.
...
ElseIf ParaTroop(*SelBeing) And *PSquare\State = #SSpawning ; Ìãíîâåííûé ïðûæîê
If Existing(*Being) : GoNNaRide(*SelBeing, *PBeing) :  EndIf
ElseIf *PBeing ; Åñëè òàì ÷òî-òî åñòü...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
EndIf
ElseIf *PSquare\State = #SRecarn : StartReincarnation(*SelBeing) ; - Ðåèíêàðíèðóåì
ElseIf *PSquare\State = #SSwitch And *Being\Interstate = #False : SwitchMood(*SelBeing) ; Èíâåðòèðóåì ðåæèì.
EndIf
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
*Being = NextActiveBeing(System\Level\CurrentPlayer) ; Èùåì ïî ñïèñêó.
If *Being And *Being = System\GUI\SelectedBeing      ; Åñëè óæå âûäåëåíà...
*Being = NextActiveBeing(System\Level\CurrentPlayer) ; ...Èùåì îïÿòü.
EndIf : If *Being ; Åñëè â ñïèñêå ÷òî-íèáóäü îñòàëîñü...
...
Case #PB_Key_O ; Îòêðûòü ïàíåëü îïöèé.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
ShowOptionsPanel()
...
SetTrackVolume(System\Options\MusicVolume)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
Case #PB_Key_Q ; Ñíîâà ïîêàçàòü áðèôèíã.
If Trim(System\Story) <> "" 
PauseThread(System\MBThread)
PrettyPrint(FormatStory(System\Story, #True), #True)
ResumeThread(System\MBThread)
EndIf
Case #PB_Key_1 To #PB_Key_0 ; Bind-êëàâèøè.
Define SCell = System\GUI\Input - #PB_Key_1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If System\GUI\Control And Linkable(System\GUI\SelectedBeing)
LinkBeing(System\GUI\SelectedBeing, SCell)               ; Ôîðìèðóåì ñâÿçü.
ElseIf System\GUI\Control : LinkBeing(#Null, SCell)      ; Îòâÿçûâàåì.
ElseIf StoreCell(SCell) And Selectable(StoreCell(SCell)) ; Åñëè íà êëàâèøå êòî-òî âèñèò...
SetOn(System\Selection, StoreCell(SCell)\Square\Entity)  ; Ñòàâèì âûäåëåíèå.
CollapseHL() : SelectBeing(StoreCell(SCell))             ; Âûäåëÿåì ñîîòâåòñòâóþùóþ Ñóùíîñòü.
EndIf
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
EndSelect
InfoHL()
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
If System\Level\ActivationFlag = #False And *Player\MovedBeings = 0 ; Åñëè íèêîãî íå æäåì è åùå íåò òàáëèöû...
If *Player\FirstBeing = #Null ; Åñëè ìû íà÷àëè ñòðîèòü òàáëèöó....
ClearDSTable() ; Î÷èñòèòü òàáëèöó îïàñíîñòåé.
EndIf
...
SetDanger(*AIBeing) : EndIf ; Âûñòàâèòü óðîâíè îïàñíîñòè.
...
If System\Level\AIFrame >= System\Options\AIDelay ; Åñëè ñðàáîòàë ñ÷åò÷èê êàäðîâ...
System\Level\AIFrame = 0 ; Îáíóëÿåì åãî.
*AIBeing = NextActiveBeing(System\Level\CurrentPlayer) ; Èùåì ñëåäóþùóþ àêòèâíóþ Ñóùíîñòü...
If *AIBeing : DeActivateBeing(*AIBeing)   ; Ñíèìàåì ôëàã àêòèâàöèè.
Run = CheckEscape(*AIBeing, *Player\Rush) ; Åñëè ñ êëåòêè íóæíî ñðî÷íî óõîäèòü...
RestartAI:
If NeedsReincarnation(*AIBeing) = #False Or Run ; Åñëè Ñóùíîñòü ïîêà íå ìîæåò ðåèíêàðíèðîâàòü...
If Run : *Victim = #Null ; Åñëè ñ êëåòêè íóæíî óáåãàòü - öåëåé íåò.
Else : *Victim = FindVictim4Absobtion(*AIBeing) ; Èùåì áëèæàéøåãî âðàãà, ÷òîáû àáñîðáèðîâàòü...
EndIf ; Ïîäâîäèì èòîãè ïðöåëèâàíèÿ:
If *Victim ; Åñëè åñòü ðåçóëüòàòû...
AbsorbBeing(*AIBeing, *Victim) ; Àáñîðáèðîâàòü íàéäåííîãî âðàãà.
Else ; Åñëè íåò ðåçóëüòàòîâ...
If Run = #False And NeedsReincarnation(*AIBeing, 1) ; Åñëè òåïåðü åñòü ñìûñë ðåèíêàðíèðîâàòü...
StartReincarnation(*AIBeing) ; Ðåíêàðíèðóåì.
ElseIf Run = #False And *AIBeing\Type = #BAmgine : StartReincarnation(*AIBeing) ; Ïåðåõîäèì â áîåâóþ ôîðìó.
ElseIf CanSpawn(*AIBeing) And System\Players(System\Level\CurrentPlayer)\IType <> #IGuardianAI
*NearestEnemy = FindNearestEnemy(*AIBeing.Being) ; Èùåì áëèæàéøåãî âðàãà, ÷òî áû ïåðåìåñòèòüñÿ ê íåìó...
*NearestSquare = FindNearestSquare4Spawning(*AIBeing, *NearestEnemy, *Player\Rush)
; ^Èùåì îïòèìàëüíóþ ïîçèöèþ äëÿ ïåðåíîñà^...
If *NearestSquare ; Åñëè ñâîáîäíàÿ ïàíåëü íàéäåíà...
If Run : *AIBeing\SuicidalStop = #True : EndIf
Run = #False ; Ñíèìàåì ôëàã ðåñòàðòà AI
*NearestEnemy = SpawnBeing(*AIBeing, *NearestSquare) ; - ðàçìíîæàåìñÿ :)
; Âûñòàâëÿåì ôëàã îñòàíîâêè â ñëó÷àå Rush'à.
...
EndIf
Else : StartReincarnation(*AIBeing) ; Ðåíêàðíèðóåì.
EndIf
*Player\MovedBeings + 1
Else
NextTurn() ; Çàâåðøàåì õîä.
EndIf
Else : System\Level\AIFrame + 1 ; Èíêðåìåíòèðóåì ñ÷åò÷èê êàäðîâ.
EndIf
EndIf
;;;;;;;; Base AI ;;;;;;;;;;;
EndMacro

Macro FadeScreen() ; Äîäåëàòü !
...
CollapseHL() ; Óáðàòü ïîäñâåòêó (íà âñÿêèé ñëó÷àé).
ForEach System\Beings() ; Ñíÿòü ôëàã ãîòîâíîñòè ñî âñåõ ñóùíîñòåé.
If System\Beings()\State = #BActive : DeActivateBeing(System\Beings()) : EndIf
Next ; ...Èíà÷å ïðîäîëæàåì...
...
TeamIdx2Color(System\Players(I)\AlliedTeam) ; Öâåò.
...
Delay(1000) ; Ïàóçà...
EndIf
If System\Level\NextMapFName <> "" And HumanWin ; Åñëè íàéäåíà ññûëêà íà ñëåäóþùóþ êàðòó...
ShowPointer_()
...
Else : System\GUI\SinFeeder + 1 : EndIf  ; Òåïåðü êýø:
...
HideEntity_(System\SubCrosses[I]) ; Ñêðûâàåì íà âñÿêèé ïîæàðíûé.
Next I
...
;;;;;Çäåñü ÷òî-òî èäåò íå òàê...
SetOn(System\Target, *PBeing\EyePoint) : ShowEntity_(System\Target) : HideEntity_(System\FrostCross)
;;;;;...Íî âîò ÷òî ?
If System\GUI\SelectedBeing\Type = #BDesire Or Not Unfreezable(*PBeing) ; Åñëè îíî âñå çàìîðàæèâàåòñÿ...
Select System\GUI\SelectedBeing\Type ; Ïî òèïó...
Case #bHunger : ShowEntity_(System\FrostCross) : ShowEntity_(System\GrandCross) ; Ïîëíûé êðåñò.
Case #bMeanie : If *PSquare\Being\Reincarnated = #False And Not Ignorant(*PBeing) And *PBeing\Frozen <= #MeanFreeze
ShowEntity_(System\FrostCross) : HideEntity_(System\GrandCross) : EndIf         ; Ïðîñòîé êðåñò.
Case #bDesire : If Not Unfreezable(*PBeing) : ShowEntity_(System\FrostCross) : HideEntity_(System\GrandCross) : EndIf
CrossWarn() ; Âñåãäà ñòàâèì ñîñåäíèå êðåñòû !
EndSelect ; Îòäåëüíî äëÿ áîìáî÷åê:
...
Else ; Åñëè íàäî ïîêàçàòü ñèëóýò - òàê è äåëàåì...
; -Update "ghost"-
...
SetOn(System\GUI\Ghost\Entity, *PSquare\Entity) ; ...À òåïåðü - àíèìàöèÿ:
...
TranslateEntity_(System\ExpressCrest, 0, 0.1, 0) ; Äëÿ çàçîðó.
EndIf
EndIf
; -Update light-
Enlight(*PSquare\Entity) ; Ïîñòàâèòü ñâåò.
EndIf
...
Next
; -Update Beings-
System\Level\ActivationFlag = #False ; Ñáðîñ ôëàãà îæèäàíèÿ àêòèâàöèè (äëÿ AI).
ForEach System\Beings()
...
AddBeing2UpdateList(*Source, MI) ; Îáíîâëÿåì èñòî÷íèê.
...
If System\Level\WaitForFinish = 0 ; Åñëè èãðà åùå ïðîäîëæàåòñÿ...
CameraControl()
If System\Level\ServiceTime = #False ; Åñëè íå èäåò îáñëóæèâàíèå...
If System\Level\Infestation = #False ; Åñëè íåò çàðàæåííûõ Ñóùíîñòåé...
If System\Players(System\Level\CurrentPlayer)\IType = #IHuman 
PlayerControl()
Else : AIControl()
EndIf
Else : InfectionControl() ; Ïåðåäàòü óïðàâëåíèå çàðàæåííûì.
EndIf
Else : DoService() ; Ïðîèçâåñòè èçìåíåíèÿ íà óðîâíå.
EndIf
Else : FadeScreen()
EndIf
EndMacro
...
; ==Main Code==
Initialization()
! MainMenuLbl: ; Ñïàñèáî Ôðåäó çà íàøå ñ÷àñòëèâîå äåòñòâî.
MainMenu()
System\MaxFPS = #GameFPS ; Âûñòàâëÿåòñÿ èãðîâîå îãðàíè÷åíèå.
Repeat
RegisterInput()
ControlBlock()
CheckResults()
